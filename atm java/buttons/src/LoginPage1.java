        ...
        if (e.getSource() == loginButton) {
            ...
            if (logininfo.containsKey(userID)) {
                ...
                if (logininfo.get(userID).equals(password)) {
                    ...
                    // Create a new WelcomePage and make it visible (uncomment if you have a WelcomePage class)
                    // new WelcomePage();
